...
## Corpus Check
- 44 files · ~49,667 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 921 nodes · 1409 edges · 63 communities (47 shown, 16 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 223 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26311327`
...
Cohesion: 0.09
Nodes (46): _cached_label(), custom_font(), _draw_active_bracket(), draw_cockpit_hud(), draw_coordinates(), draw_crosshair(), _draw_dim_bracket(), draw_dodge_bg() (+38 more)

### Community 3 - "Asteroid Generation & Mesh Rendering"
Cohesion: 0.06
Nodes (19): Asteroid, AsteroidField, Create smaller fragments that explode away from each other., Game, Render a secondary pass for the magnified aim window., Render a secondary pass for the magnified aim window., Render a secondary pass for the magnified aim window., Render a secondary pass for the magnified aim window. (+11 more)
...
Cohesion: 0.12
Nodes (12): Dogfighter, Minelayer, StealthInterceptor, CorvetteTurret, EnemyProjectile, HomingBolt, MachineGunBolt, Mine (+4 more)
...
Cohesion: 0.17
Nodes (7): Rotate nose toward desired_heading at turn_rate, fire main thrust,         apply, True when close to target and still closing fast — signal to flip and brake., Triggers proximity explosion and deals radial damage to player., Triggers proximity explosion and deals radial damage to player., SuicideDrone, get_forward_from_quat(), Extract just the forward (Z) vector from a quaternion — avoids full basis build.
...
- **Why does `WaveDirector` connect `Scripted Encounter Timelines` to `Asteroid Generation & Mesh Rendering`, `Carrier Bounding Box Collision`, `Enemy Projectiles & Weapon Behaviors`, `Player Ship Flight Mechanics`, `Encounter Spawn Director & AI`, `Sniper Flank Enemy AI`?**
